...
Running Shinny Web app can be found at  https://frisbie17.shinyapps.io/siapp/

R Shiny as a Simulation Interface
Introduction
...
We now have everything we need to run our M/M/1 queue model using R. Before we introduce the added complexities of Shiny we will demonstrate the functionality from R. In the code below we will: 1. Set our two input parameters, 2. Write our configuration file, 3. Run the simulation, 4. Get our results.
#1. Set Inputs
